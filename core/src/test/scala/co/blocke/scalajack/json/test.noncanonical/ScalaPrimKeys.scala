  ...
  describe("----------------------------------------\n:  Scala Primitive Noncanonical Tests  :\n----------------------------------------") {
    ...
    describe("--- Negative Tests ---") {
      ...
      it("Bad Enumeration Key") {
        ...
        val msg = """ReadException(1 error):
                    |  [$.m.Bogus] Enumeration co.blocke.scalajack.json.test.noncanonical.Size$ does not contain a value named Bogus (reported by: co.blocke.scalajack.typeadapter.EnumerationIRTransceiver)""".stripMargin
