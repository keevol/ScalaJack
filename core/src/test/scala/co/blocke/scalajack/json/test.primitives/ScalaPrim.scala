    ...
    describe("--- Negative Tests ---") {
      it("BigDecimal must break") {
        ...
        val msg = """ReadException(1 error):
                    |  [$.bd5] Expected a JSON number, not JString(0.1499999999999999944488848768742172978818416595458984375) (reported by: co.blocke.scalajack.typeadapter.BigDecimalTypeAdapter$$anon$1)""".stripMargin
      ...
      it("Boolean must break") {
        ...
        val msg = """ReadException(1 error):
                      |  [$.bool2] Expected a JSON boolean (reported by: co.blocke.scalajack.typeadapter.BooleanTypeAdapter$$anon$1)""".stripMargin
        ...
        val msg2 = """ReadException(1 error):
                       |  [$.bool2] Expected a JSON boolean (reported by: co.blocke.scalajack.typeadapter.BooleanTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleBoolean](js2) should have message msg2
        val js3 = """{"bool1":true,"bool2":null}"""
        val msg3 = """ReadException(1 error):
                       |  [$.bool2] Expected a JSON boolean (reported by: co.blocke.scalajack.typeadapter.BooleanTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleBoolean](js3) should have message msg3
      }
      it("Byte must break") {
        val js = """{"b1":927,"b2":-128,"b3":0,"b4":64}"""
        val msg = """ReadException(1 error):
                      |  [$.b1] Byte value out of range (reported by: co.blocke.scalajack.typeadapter.ByteTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleByte](js) should have message msg
        val js2 = """{"b1":true,"b2":-128,"b3":0,"b4":64}"""
        val msg2 = """ReadException(1 error):
                       |  [$.b1] Expected a JSON number (byte) (reported by: co.blocke.scalajack.typeadapter.ByteTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleByte](js2) should have message msg2
      }
      it("Char must break") {
        val js = """{"c1":null,"c2":"Y","c3":"Z"}"""
        val msg = """ReadException(1 error):
                      |  [$.c1] Expected a char (JSON string of length 1) (reported by: co.blocke.scalajack.typeadapter.CharTypeAdapter$$anon$1)""".stripMargin
      ...
      it("Enumeration must break") {
        ...
        val msg = """ReadException(1 error):
                      |  [$.e2] Enumeration co.blocke.scalajack.json.test.primitives.Size$ does not contain a value named Bogus (reported by: co.blocke.scalajack.typeadapter.EnumerationIRTransceiver)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleEnum](js) should have message msg
        val js2 = """{"e1":"Small","e2":"Medium","e3":"Large","e4":null,"e5":9}"""
        val msg2 = """ReadException(1 error):
                       |  [$.e5] Enumeration co.blocke.scalajack.json.test.primitives.Size$ does not contain a value at index 9 (reported by: co.blocke.scalajack.typeadapter.EnumerationIRTransceiver)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleEnum](js2) should have message msg2
      }
      it("Float must break") {
      ...
      it("Int must break") {
        ...
        val msg = """ReadException(1 error):
                      |  [$.i3] Expected a JSON int, not JString(0) (reported by: co.blocke.scalajack.typeadapter.IntTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleInt](js) should have message msg
        val js2 = """{"i1":2147483647,"i2":-2147483648,"i3":2.3,"i4":123}"""
        val msg2 = """ReadException(1 error):
                       |  [$.i3] Expected a JSON int, not JDecimal(2.3) (reported by: co.blocke.scalajack.typeadapter.IntTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleInt](js2) should have message msg2
      }
      it("Long must break") {
        ...
        val msg2 = """ReadException(1 error):
                       |  [$.l3] Expected a JSON number (long) (reported by: co.blocke.scalajack.typeadapter.LongTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleLong](js2) should have message msg2
      }
      it("Short must break") {
        val js = """{"s1":32767,"s2":true,"s3":0,"s4":123}"""
        val msg = """ReadException(1 error):
                      |  [$.s2] Expected a JSON number (short), not JBool(true) (reported by: co.blocke.scalajack.typeadapter.ShortTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleShort](js) should have message msg
        val js2 = """{"s1":32767,"s2":3.4,"s3":0,"s4":123}"""
        val msg2 = """ReadException(1 error):
                       |  [$.s2] Expected a JSON number (short), not JDecimal(3.4) (reported by: co.blocke.scalajack.typeadapter.ShortTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleShort](js2) should have message msg2
      }
      it("String must break") {
        val js = """{"s1":"something","s2":-19,"s3":null}"""
        val msg = """ReadException(1 error):
                      |  [$.s2] Expected a JSON string (reported by: co.blocke.scalajack.typeadapter.StringTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleString](js) should have message msg
      }
    }
  }
}
