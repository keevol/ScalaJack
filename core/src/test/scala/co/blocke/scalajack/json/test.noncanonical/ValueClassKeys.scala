  ...
  describe("-----------------------------------\n:  ValueClass Noncanonical Tests  :\n-----------------------------------") {
    ...
    describe("--- Negative Primitive Tests ---") {
      it("Bad BigDecimal Key") {
        ...
        val msg = """ReadException(1 error):
                    |  [$.m.true] Expected a JSON number, not JBool(true) (reported by: co.blocke.scalajack.typeadapter.BigDecimalTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCBigDecimal](js) should have message msg
      }
      it("Bad BigInt Key") {
        val js = """{"m":{12.5:56}}"""
        val msg = """ReadException(1 error):
                    |  [$.m."12.5"] Rounding necessary (reported by: co.blocke.scalajack.typeadapter.BigIntTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCBigInt](js) should have message msg
      }
      it("Bad Byte Key") {
        val js = """{"m":{12234:56}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.12234] Byte value out of range (reported by: co.blocke.scalajack.typeadapter.ByteTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCByte](js) should have message msg
      }
      it("Bad Boolean Key") {
        val js = """{"m":{1:false}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.1] Expected a JSON boolean (reported by: co.blocke.scalajack.typeadapter.BooleanTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCBoolean](js) should have message msg
      }
      it("Bad Char Key") {
        val js = """{"m":{null:"A"}}"""
        val msg = """ReadException(1 error):
        ...
        the[ReadException] thrownBy sj.read[SampleVCChar](js) should have message msg
      }
      it("Bad Double Key") {
        val js = """{"m":{false:56.78}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.false] Expected a JSON number, not JBool(false) (reported by: co.blocke.scalajack.typeadapter.DoubleTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCDouble](js) should have message msg
      }
      it("Bad Enumeration Key") {
        val js = """{"m":{"Bogus":"Meat"}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.Bogus] Enumeration co.blocke.scalajack.json.test.noncanonical.Food$ does not contain a value named Bogus (reported by: co.blocke.scalajack.typeadapter.EnumerationIRTransceiver)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCEnumeration](js) should have message msg
      }
      it("Bad Float Key") {
        val js = """{"m":{"hey":56.2}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.hey] Expected a JSON number (reported by: co.blocke.scalajack.typeadapter.FloatTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCFloat](js) should have message msg
      }
      it("Bad Int Key") {
        val js = """{"m":{12.5:56}}"""
        val msg = """ReadException(1 error):
                    |  [$.m."12.5"] Expected a JSON int, not JDecimal(12.5) (reported by: co.blocke.scalajack.typeadapter.IntTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCInt](js) should have message msg
      }
      it("Bad Long Key") {
        val js = """{"m":{12.5:56}}"""
        val msg = """ReadException(1 error):
                    |  [$.m."12.5"] Expected a JSON number (long) (reported by: co.blocke.scalajack.typeadapter.LongTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCLong](js) should have message msg
      }
      it("Bad Short Key") {
        val js = """{"m":{12.5:56}}"""
        val msg = """ReadException(1 error):
                    |  [$.m."12.5"] Expected a JSON number (short), not JDecimal(12.5) (reported by: co.blocke.scalajack.typeadapter.ShortTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCShort](js) should have message msg
      }
      it("Bad UUID Key") {
        val js = """{"m":{"bogus":"54cab778-7b9e-4b07-9d37-87b97a011e55"}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.bogus] Invalid UUID string: bogus (reported by: co.blocke.scalajack.typeadapter.UUIDTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCUUID](js) should have message msg
      }
    }
    ...
    describe("--- Negative Complex Tests ---") {
      it("Bad Case Class Key") {
        ...
        val msg = """ReadException(1 error):
                    |  [$.simple.name] Required field name missing (reported by: co.blocke.scalajack.typeadapter.StringTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCClass](js) should have message msg
      }
      it("Bad Trait Key") {
        ...
        val msg = """ReadException(1 error):
                    |  [$.m.{"_hint":"co.block...}] Exception was thrown: java.lang.ClassNotFoundException: Unable to find class named "co.blocke.scalajack.json.test.noncanonical.Bogus"
      ...
      it("Bad Parameterized Case Class Key") {
        ...
        val msg = """ReadException(1 error):
                    |  [$.a] Expected a JSON int, not JDecimal(5.5) (reported by: co.blocke.scalajack.typeadapter.IntTypeAdapter$$anon$1)""".stripMargin
        the[ReadException] thrownBy sj.read[SampleVCParamClass[String, Int]](js) should have message msg
      }
      it("Bad Parameterized Trait Key") {
        val js = """{"m":{{"_hint":"co.blocke.scalajack.json.test.noncanonical.ZThing","a":5,"b":"wow"}:{"_hint":"co.blocke.scalajack.json.test.noncanonical.AThing","a":6,"b":"zoom"}}}"""
        val msg = """ReadException(1 error):
                    |  [$.m.{"_hint":"co.block...}] Exception was thrown: java.lang.ClassNotFoundException: Unable to find class named "co.blocke.scalajack.json.test.noncanonical.ZThing"
                    | (reported by: unknown)""".stripMargin
